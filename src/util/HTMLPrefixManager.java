...
/**
 * The Class HTMLPrefixManager.
 *
 * @author Matthew Horridge, The University Of Manchester, Information
 *         Management Group
 * @since 2.2.0
 */
public class HTMLPrefixManager implements PrefixManager, ShortFormProvider, IRIShortFormProvider {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 40000L;
    
    /** The prefix2 namespace map. */
    @Nonnull
    private Map<String, String> prefix2NamespaceMap;
    
    /** The reverseprefix2 namespace map. */
    @Nonnull
    ...
    /**
     * Instantiates a new HTML prefix manager.
     *
     * @param defaultPrefix        default prefix
     */
    @Deprecated
    public HTMLPrefixManager(@Nullable String defaultPrefix) {
     ...
     * @param defaultPrefix        default prefix
     */
    public HTMLPrefixManager(@Nullable PrefixManager pm, @Nullable StringComparator c,
     ...
     */
    public HTMLPrefixManager() {
        this(null, null, null);
    }

    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#getPrefixComparator()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#setPrefixComparator(org.semanticweb.owlapi.util.StringComparator)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#clear()
     */
    @Override
    public void clear() {
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#getPrefixNames()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#setDefaultPrefix(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#getPrefixIRI(org.semanticweb.owlapi.model.IRI)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#getDefaultPrefix()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#containsPrefixMapping(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#copyPrefixesFrom(org.semanticweb.owlapi.model.PrefixManager)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#copyPrefixesFrom(java.util.Map)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#getIRI(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#getPrefixName2PrefixMap()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#getPrefix(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#setPrefix(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.model.PrefixManager#unregisterNamespace(java.lang.String)
     */
    @Override
    ...
    public String getShortFormInHTML(IRI iri) {
        ...
        if (sf == null) {
            return "<a href=\"javascript:;\" class=\"owl-entity-short-form\" title=\"" + iri.toString() + "\">" + iri.getShortForm() + "</a>";
        } else {
            return "<a href=\"javascript:;\" class=\"owl-entity-short-form\" title=\"" + sf + "\">" + sf + "</a>";
        }
    }

    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.util.IRIShortFormProvider#getShortForm(org.semanticweb.owlapi.model.IRI)
     */
    @Override
    public String getShortForm(IRI iri) {
    	return getShortFormInHTML(iri);
//        String sf = getPrefixIRI(iri);
//        if (sf == null) {
//            return iri.toString();
//        } else {
...
//        }
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.util.ShortFormProvider#getShortForm(org.semanticweb.owlapi.model.OWLEntity)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.semanticweb.owlapi.util.ShortFormProvider#dispose()
     */
    @Override
    public void dispose() {}
}
